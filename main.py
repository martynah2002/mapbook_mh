...
class User:
    ...
    def get_coordinates(self) -> list:
        ...
        headers = {"User-Agent": "Mapbook_ef (emilia.fiedorowicz@student.wat.edu.pl)"}
        response_html = BeautifulSoup(requests.get(adres_url, headers=headers).text, 'html.parser')
        return [
